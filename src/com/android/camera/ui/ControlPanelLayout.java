...
public class ControlPanelLayout extends RelativeLayout {
	...
	//modify by cym 20130723
        //super.onMeasure(widthSpec, heightSpec);
	if((widthSpec == 1073742096) && (heightSpec == 1073741941))
        {
                Log.e(TAG, "4.3 Inch Screen\n");
                super.onMeasure(widthSpec, /*heightSpec*/MeasureSpec.makeMeasureSpec(110, MeasureSpec.EXACTLY));
        }
        else
	{
		Log.e(TAG, "9.7 or 7.0 Inch Screen\n");
		super.onMeasure(MeasureSpec.makeMeasureSpec(260, MeasureSpec.EXACTLY),
			MeasureSpec.makeMeasureSpec(570, MeasureSpec.EXACTLY));
	}
